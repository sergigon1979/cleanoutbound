...
<p style="margin-top: 1.5rem;"><strong>The fuel that powered Empire</strong></p>
...
<div style="text-align: center; margin: 2rem 0;">
  <img src="../../assets/jevons-chart.png"
       alt="Jevons's original chart from The Coal Question — four exponential curves: population, imports, coal vend from Newcastle, supposed consumption of coal in Britain."
       style="max-width: 70%; height: auto;">
</div>

<p style="text-align: center; font-size: 0.85em; color: #888; margin-top: -0.5rem;">Jevons' charts. Is that your projected ARR?³</p>
...
<p style="margin-top: 1.5rem;"><strong>At a bar</strong></p>
...
<p style="margin-top: 1.5rem;"><strong>Newcomen's engine doesn't fit the barbershop</strong></p>
...
<p style="margin-top: 1.5rem;"><strong>Runaway warming</strong></p>
...
<p style="margin-top: 1.5rem;"><strong>PIZZA</strong></p>
...
<div class="co-exhibit co-exhibit--takeaways">
  ...
  <div class="box">
    ...
    <ul>
      ...
      <li><strong>The cold emailer's costs land on the recipient.</strong> The coal user still paid for coal. The sender just pays for Apollo. No cost signal, no brake on volume.</li>
...
<p>¹⁵ Price elasticity of demand measures how much the quantity demanded changes when price changes. When the sender's marginal cost approaches zero — because the real costs are borne by the recipient — even a small reduction in sending cost produces a massive increase in volume. In economic terms, demand becomes nearly perfectly elastic with respect to private cost.
